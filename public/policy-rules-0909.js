...
(function(){
  ...
  window.DASHBOARD_POLICY={isLubricant:isLub,isTire,isCdi,notes:{semGiro:'Lubrificantes excluídos: o consumo desta família não está representado na base de baixas recebida.',replenishment:'Pneus e câmaras de ar excluídos de toda reposição de estoque. Permanecem apenas para controle do saldo existente.',cdi:'Pneus e câmaras de ar excluídos do estoque-alvo do CDI Chua por decisão de política de abastecimento.'}};
  ...
  // Pneus/câmaras não entram em estoque mínimo, criticidade, necessidade de compra nem transferências para reposição.
  ...
  function patchPolicyViews(){
    ...
    // Resumo executivo novo: corrige capital sem giro e explicita política de pneus.
